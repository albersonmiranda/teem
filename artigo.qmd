...
1. **Apresentação da música**: O professor reproduz a música para os alunos, que devem ouvir atentamente e tentar identificar os valores rítmicos presentes.
    - Recurso: mídia ou instrumento musical.

Na última etapa, após a reprodução da música, o professor, junto com os alunos, devem realizar a divisão da letra da música em notas e compassos — que, por conta da música escolhida, é quase uma divisão silábica. A partir daí, os alunos devem apontar quais as figuras rítmicas representam cada trecho da letra e preencher no caderno.
